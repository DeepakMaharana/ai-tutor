    ...
    if (reflection) {
      ...
      try {
        const response = await axios({
          ...
          data: {
            contents: [
              { parts: [{ text: topics[currentTopic + 1].ai_prompt }] },
            ],
          },
        });
          ...
          <div className="md:col-span-2 p-6">
            <div className="h-full flex flex-col">
              ...
              {!showReflection ? (
                ...
                <QuizSection
                  quizQuestions={topics[currentTopic].quiz.questions}
                  onQuizComplete={(bool) => setReflection(bool)}
                />
